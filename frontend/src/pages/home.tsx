...
import { useAllProductsQuery, useLatestProductsQuery } from "../redux/api/productAPI";
      ...
      <div className="home">
        ...
        <main>
          {isLoading ? (
            ...
            data?.products.slice(6,11).map((i) => (
              <ProductCard
                key={i._id}
                productId={i._id}
                name={i.name}
        ...
        <main>
          {isLoading ? (
            ...
            data?.products.slice(11,16).map((i) => (
              <ProductCard
                key={i._id}
                productId={i._id}
                name={i.name}
        ...
        <main>
          {isLoading ? (
            ...
            data?.products.slice(16,21).map((i) => (
              <ProductCard
                key={i._id}
                productId={i._id}
                name={i.name}
